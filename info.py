...
URL = "https://gen-v.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://gen-v.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://gen-v.onrender.com/".format(FQDN)
else:
    URL = "https://gen-v.onrender.com/".format(FQDN)
