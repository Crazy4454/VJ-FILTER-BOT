...
API_ID = int(environ.get('API_ID', '25687938'))
API_HASH = environ.get('API_HASH', '8107c210829f74c504df5510f4f3718a')
BOT_TOKEN = environ.get('BOT_TOKEN', "6748724257:AAEzh0CxfPMOhhb-zYAwPqDLDQCPVYRD1AE")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '761699798').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001672693478').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://crazy4454:crazy@123@cluster0.ntpvrum.mongodb.net/?retryWrites=true&w=majority")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+_kq35oaJOpY1ZDBl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+_kq35oaJOpY1ZDBl')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001675037381'))
...
URL = "https://gen-x-9vmq.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://gen-x-9vmq.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://gen-x-9vmq.onrender.com/".format(FQDN)
else:
    URL = "https://gen-x-9vmq.onrender.com/".format(FQDN)
